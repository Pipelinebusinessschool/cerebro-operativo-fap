# VSL larga de FAP — prueba + mecanismo (adaptada del insight "ecosistema híbrido")

> **Generada por el cerebro FAP** · skill `fap-vsl` (+ `fap` fuente de verdad). Ruta A: Ads → **VSL** →
> Diagnóstico. Guion **hablado**, Jorge a cámara, de corrido, sin cortes a video externo.
>
> **Adaptación, no copia — qué se transformó y por qué (candado #1):**
> - **ICP retargeteado.** El insight vende a *coaches/consultores/cursos* con promesa de ingreso
>   personal ("$10K–$100K extras al mes"). FAP es **B2B para empresas ≥$1M/año con ≥2 vendedores**.
>   Se retargetea al ICP de FAP y **se elimina toda promesa de ingreso garantizado** (candado de voz).
> - **Cifras y clientes del original NO se usan** (300 casos, $300M, $10M cash collected, $4M en
>   prueba/error, "$50K con Hormozi", Claudia/Alexis/Aloina/Jean/Sara/César/Teresa, "IA de $50.000",
>   "20% de 1.500 llamadas"): **no están en `contexto/`**. Se sustituyen por lo **sourced**: los 2
>   casos reales (`prueba.md`), el Set B y la autoridad (+47.000 · +120 · +$150M · Harvard · Forbes).
> - **Plazo corregido:** FAP es **6 meses 1:1**, no "7–14 días". Los plazos citados (4 meses · 120
>   días) son los **reales de los casos**, para resultados — nunca como promesa.
> - **CTA:** "llamada de demostración" → **diagnóstico** (candado). Sin precio. Sin "somos los únicos".
> - Resultados siempre **"para quien implementa, ejecuta y sigue el paso a paso"**.
>
> Estructura conservada del insight: **prueba/matemática → mecanismo de 3 pasos (= 6 pilares) → oferta
> reencuadrada → calificación/reversión de riesgo → costo de inacción → CTA a diagnóstico.**
> ~700 palabras ≈ **4 min**. Cifras en números, porcentajes con `%`, preguntas retóricas para el ritmo.

---

## Guion

**HOOK — dos opciones (elegir / A-B):**

> **Hook 1 (dependencia del fundador):** En los próximos cuatro minutos te voy a mostrar, con números,
> por qué y cómo podemos volver predecible la facturación de tu operación de ventas — y quitarle a tu
> empresa la dependencia de que seas tú quien la sostiene.
>
> **Hook 2 (tomapedidos → fábrica de ingresos · recomendado):** En los próximos cuatro minutos te voy a
...
- [x] ICP de FAP explícito (B2B ≥$1M, con equipo de ventas); coaches/cursos fuera.
- [x] **Sin promesa de ingreso** ("$X al mes"); resultados sourced y condicionados.
- [x] Cifras **sourced** (2 casos reales + Set B + autoridad), pegadas a su afirmación.
- [x] **Sin precio de FAP.** · Plazo real (6 meses 1:1; casos a 4 meses / 120 días).
- [x] CTA único al **diagnóstico**, con reencuadre "no es una llamada de ventas".
- [x] Voz de Jorge · problema sistémico · una sola construcción "no es X, es Y" (la del diagnóstico).
- [x] "Para quien implementa" presente. · Sin "somos los únicos/los mejores".
- [x] Jorge a cámara, de corrido, sin video externo.

## Ajustes de Jorge aplicados (ronda 2)

- **"Vende la empresa / who are them":** se nombra el calibre de clientes — +120 empresas (+$2M
  promedio, algunas Fortune 500) y directivos que hoy dirigen operaciones en Google, SAP o Cisco (muro
  de logos sourced en `autoridad.md`), "otras por contrato no puedo nombrarlas".
- **Cifras de PBS añadidas:** cumplimiento de cuota, retorno por vendedor (SRO), gross profit y ventas
  por empleado, además de SROI, pipeline coverage y forecast accuracy.
- **Autoridad reformulada** (dictado de Jorge): desde 2019 · +47 mil profesionales (escalamiento de
  pipeline) · +10 mil directivos (construcción de sistemas) · +120 empresas +$2M · Fortune 500.
- **6 pilares explícitos** (antes solo "tres frentes").
- **PIPELINE OS + squad de agentes de IA + stack** (revenue intelligence, GPTs, modelos de
  contratación, metodologías de supervisión) integrados en la oferta — sourced en `jorge_decisions.md`
  §2/§4 (AI-first, N8N, revenue intelligence).
- **Dos hooks** conservados como opciones A/B (recomendado el 2, "tomapedidos → fábrica de ingresos").

> ⚠️ **Discrepancia a resolver (Jorge decide).** Las cifras de autoridad que dictó Jorge para esta VSL
> (**desde 2019 · +47 mil · +10 mil directivos**) **no coinciden** con el **bloque canónico** de
> `contexto/autoridad.md` (**15+ años · +42.000 · +12.000 directivos · Harvard desde 2023**), que se
> pega verbatim en landings. No toqué el canónico para no romper otras piezas. **Si estas cifras son
> las nuevas oficiales, hay que actualizar `autoridad.md` una sola vez** y unificar todo.

## Opcional (no bloquea)

El insight ofrece un *lead magnet* pre-llamada ("playbook de las 8C"). FAP **no tiene** ese asset en la
fuente; si Jorge quiere ofrecer un recurso antes del diagnóstico, hay que definirlo — no se inventa.
