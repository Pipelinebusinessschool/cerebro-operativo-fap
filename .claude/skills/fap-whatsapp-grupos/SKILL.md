---
name: fap-whatsapp-grupos
description: >-
  Redacta mensajes de comunidad y grupos de WhatsApp de FAP (hype pre-evento, coordinación en viv
  o). Úsala al escribir contenido para grupos o comunidad de WhatsApp de FAP.
---
